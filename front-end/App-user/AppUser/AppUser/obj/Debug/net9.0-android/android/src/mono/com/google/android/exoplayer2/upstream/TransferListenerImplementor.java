...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Google.Android.Exoplayer2.Upstream.ITransferListenerImplementor, ExoPlayer.DataSource", TransferListenerImplementor.class, __md_methods);
	}
	...
	public TransferListenerImplementor ()
	{
		...
		if (getClass () == TransferListenerImplementor.class) {
			mono.android.TypeManager.Activate ("Com.Google.Android.Exoplayer2.Upstream.ITransferListenerImplementor, ExoPlayer.DataSource", "", this, new java.lang.Object[] {  });
		}
	}
